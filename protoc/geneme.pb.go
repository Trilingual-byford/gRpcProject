...
func (x *UserRequest) Reset() {
	*x = UserRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_geneme_proto_msgTypes[0]
...
func (*UserRequest) Descriptor() ([]byte, []int) {
	return file_geneme_proto_rawDescGZIP(), []int{0}
}
...
func (x *UserResponse) Reset() {
	*x = UserResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_geneme_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserResponse) Descriptor() ([]byte, []int) {
	return file_geneme_proto_rawDescGZIP(), []int{1}
}
...
var File_geneme_proto protoreflect.FileDescriptor

var file_geneme_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x67, 0x65, 0x6e, 0x65, 0x6d, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05,
	...
	0x6f, 0x62, 0x62, 0x79, 0x32, 0x49, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x74, 0x6f, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_geneme_proto_rawDescOnce sync.Once
	file_geneme_proto_rawDescData = file_geneme_proto_rawDesc
)

func file_geneme_proto_rawDescGZIP() []byte {
	file_geneme_proto_rawDescOnce.Do(func() {
		file_geneme_proto_rawDescData = protoimpl.X.CompressGZIP(file_geneme_proto_rawDescData)
	})
	return file_geneme_proto_rawDescData
}

var file_geneme_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_geneme_proto_goTypes = []interface{}{
	(*UserRequest)(nil),  // 0: proto.UserRequest
	(*UserResponse)(nil), // 1: proto.UserResponse
}
var file_geneme_proto_depIdxs = []int32{
...
func init() { file_geneme_proto_init() }
func file_geneme_proto_init() {
	if File_geneme_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_geneme_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_geneme_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_geneme_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_geneme_proto_goTypes,
		DependencyIndexes: file_geneme_proto_depIdxs,
		MessageInfos:      file_geneme_proto_msgTypes,
	}.Build()
	File_geneme_proto = out.File
	file_geneme_proto_rawDesc = nil
	file_geneme_proto_goTypes = nil
	file_geneme_proto_depIdxs = nil
}
